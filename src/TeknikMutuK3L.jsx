    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-stretch animate-fadeIn font-sans text-xs">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200 flex flex-col justify-between space-y-5">
        ...
        <div className="border border-slate-100 rounded-xl p-3 bg-slate-50/50">
          <p className="font-bold text-slate-800 mb-1 uppercase tracking-wide text-[10px]">
            Implementasi BIM Compliance
          </p>
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex-1 space-y-1 text-[10px] font-medium text-slate-600 pl-2">
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-[#000075]" /> 20 Comply
              </div>
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-[#BD002F] animate-pulse" />{" "}
                1 Not Comply (KSPP Merauke)
              </div>
              <div className="flex items-center gap-1.5">
                <span
                  className="w-2 h-2 rounded-full bg-am-50"
        ...
        <div className="border border-slate-100 rounded-xl p-3 space-y-2">
          <p className="font-bold text-slate-800 uppercase tracking-wide text-[10px]">
            Digital Surveying Compliance
          </p>
          <div className="p-2 bg-red-50 rounded-lg text-slate-700 border border-red-100 font-medium">
            <span className="font-black text-[#BD002F] block mb-0.5">
              ⚠️ Not Comply (Drone Obstacle):
            </span>
            Irigasi KSPP Merauke Paket 1 (Kendala Personil Lapangan) &amp;
            Struktur Jembatan Musi (Cuaca Buruk).
          </div>
        </div>
        ...
        <div className="border border-slate-100 rounded-xl p-3 space-y-1.5 bg-slate-50/30">
          ...
          <div className="grid grid-cols-2 gap-2 text-[10px] font-semibold text-slate-700">
            <div className="bg-white p-2 rounded border border-slate-100">
              <span className="text-blue-700 font-black block text-[11px]">
                7 Proyek
              </span>
              Jalan &amp; Akses Tol (Japek, Kretek, Patimban, Bocimi 3A/3B)
            </div>
            <div className="bg-white p-2 rounded border border-slate-100">
              <span className="text-amber-600 font-black block text-[11px]">
                3 Proyek
              </span>
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200 flex flex-col justify-between space-y-5">
        ...
        <div className="bg-gradient-to-br from-red-50 to-white rounded-xl p-3.5 border border-red-100 flex items-center justify-between">
          <div>
            <p className="text-slate-500 font-bold text-[10px] uppercase tracking-wide">
              Jumlah NCR Not Comply
            </p>
            <h4 className="text-2xl font-black text-[#BD002F] mt-0.5">
              15 Temuan
            </h4>
          </div>
        ...
        <div className="border border-slate-100 rounded-xl p-3 bg-slate-50/50">
          <p className="font-bold text-slate-800 mb-1.5 uppercase tracking-wide text-[10px]">
            Penilaian Kinerja Mutu (Target &ge; 80)
          </p>
          <div className="p-2 bg-white rounded border border-slate-100 space-y-1">
            ...
            <p className="text-slate-500 text-[10px] leading-relaxed font-medium">
              • **Irigasi KSPP Merauke** (Nilai Mutu: 33)
              <br />• **IPAL 1,2,3 IKN** (Proses perbaikan lapangan, Nilai Mutu:
              23)
            </p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200 flex flex-col justify-between space-y-5">
        ...
        <div className="border border-slate-100 rounded-xl p-3 bg-gradient-to-br from-slate-900 to-slate-800 text-white font-mono text-[10px] space-y-1">
          <div className="text-emerald-400 font-bold tracking-wider uppercase font-sans text-[9px] mb-1">
            √ STATISTIK KECELAKAAN KERJA
          </div>
          <div className="flex justify-between border-b border-white/5 pb-0.5">
            <span className="text-slate-400">Jumlah Nearmiss:</span>
            <span className="font-bold text-white">12 Kasus</span>
          </div>
          <div className="flex justify-between border-b border-white/5 pb-0.5">
            <span className="text-slate-400">Jumlah Jam Kerja:</span>
            <span className="font-bold text-white">4.937.647 Jam</span>
          </div>
          <div className="flex justify-between text-emerald-400 font-bold">
            <span className="font-sans">STATUS UTAMA:</span>
        ...
        <div className="border border-slate-100 rounded-xl p-3 bg-slate-50/50">
          <p className="font-bold text-slate-800 mb-1.5 uppercase tracking-wide text-[10px]">
            Penilaian Kinerja K3L (Target &ge; 80)
          </p>
          <div className="p-2 bg-white rounded border border-slate-100 text-slate-600 font-medium space-y-1">
            <span className="text-[#BD002F] font-black block">
              Akar Masalah Lapangan:
            </span>
            Dokumen eksternal masih tertahan di owner, aktivitas di site belum
            memiliki direksi keet permanen, serta keterbatasan akses jalan kerja
            utama (IKN &amp; Merauke).
          </div>
        </div>
      </div>
