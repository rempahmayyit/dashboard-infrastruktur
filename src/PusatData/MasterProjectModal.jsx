...
export default function MasterProjectModal({ project, onClose, onSaved }) {
  const [form, setForm] = useState({
    ...
    kadiv: project.kadiv || "",
    wakadiv: project.wakadiv || "",
    kepala_departemen: project.kepala_departemen || "",
    kepala_proyek_current: project.kepala_proyek_current || "",
    owner: project.owner || "",
    id_owner: project.id_owner || "",
    end_date: project.end_date || "",
    lokasi_provinsi: project.lokasi_provinsi || "",
    jenis_proyek: project.jenis_proyek || "",
    jenis_kontrak: project.jenis_kontrak || "",
    jenis_proyek_lainnya: "",
    jenis_kontrak_lainnya: "",
    tipe_proyek_lainnya: "",
    psn: project.psn || "",
    tipe_proyek: project.tipe_proyek || "",
    nk_current: project.nk_current || 0,
    bk_mapp_kumulatif_current: project.bk_mapp_kumulatif_current || 0,
    pu_mapp_kumulatif_current: project.pu_mapp_kumulatif_current || 0,
    start_date: project.start_date || "",
    end_date_current: project.end_date_current || "",
    longitude: project.longitude || "",
    latitude: project.latitude || "",
    link_drone: project.link_drone || "",
    cctv_available: project.cctv_available || false,
  });
  ...
  const handleSave = async () => {
    try {
      ...
      const cleanedForm = {
        ...
        nk_current:
          form.nk_current === "" ||
          form.nk_current === null ||
          form.nk_current === undefined
            ? null
            : Number(form.nk_current),

        bk_mapp_kumulatif_current:
          form.bk_mapp_kumulatif_current === "" ||
          form.bk_mapp_kumulatif_current === null ||
          form.bk_mapp_kumulatif_current === undefined
            ? null
            : Number(form.bk_mapp_kumulatif_current),

        pu_mapp_kumulatif_current:
          form.pu_mapp_kumulatif_current === "" ||
          form.pu_mapp_kumulatif_current === null ||
          form.pu_mapp_kumulatif_current === undefined
            ? null
            : Number(form.pu_mapp_kumulatif_current),

        start_date: form.start_date || null,
        end_date: form.end_date || null,
        end_date_current: form.end_date_current || null,
      };
      ...
      <div className="bg-white w-full max-w-4xl max-h-[90vh] rounded-2xl shadow-2xl flex flex-col">
        <div className="border-b p-5 flex justify-between items-center">
          <h2 className="text-xl font-bold text-slate-800">
            Edit Project: {project.id_project}
          </h2>
          <button
            onClick={onClose}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  type="number"
                  className="w-full border rounded-xl p-3"
                  value={form.bk_mapp_kumulatif_current}
                  onChange={handleChange}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  type="number"
                  className="w-full border rounded-xl p-3"
                  value={form.pu_mapp_kumulatif_current}
                  onChange={handleChange}
                />
              </div>
        ...
        <div className="border-t p-5 flex justify-end gap-3 bg-slate-50 rounded-b-2xl">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="px-6 py-2.5 bg-[#000075] hover:bg-blue-900 text-white font-medium rounded-xl transition disabled:opacity-50"
          >
